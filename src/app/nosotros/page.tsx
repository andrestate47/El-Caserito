...
export default function NosotrosPage() {
  ...
  return (
    <main className="relative min-h-screen selection:bg-[#D4AF37] selection:text-[#0A183C]">
      ...
      <div className="relative z-10">
        ...
        <section className="relative py-24 md:py-48 px-4 md:px-6 flex justify-center min-h-[120vh]">
